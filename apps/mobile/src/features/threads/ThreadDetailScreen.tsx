...
import type { ThreadRecoveryRetryInput } from "./ThreadRecoveryNotice";
      ...
      {showContent ? (
        ...
        >
          <ThreadFeed
            ...
            recoveryPresentation={props.recoveryPresentation}
            listRef={listRef}
            freeze={freeze}
            ...
            onRetryInterruptedTurn={props.onRetryInterruptedTurn}
          />
        </View>
      ) : (
        <View className="flex-1" />
